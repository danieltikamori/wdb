...
function capitalize(wordToCapitalize) {
  ...
  wordToCapitalize = wordToCapitalize.replace(slicedWord, slicedWord.toUpperCase()); // replace the first char(the single char, to upper cased char)
  return wordToCapitalize; // or just return wordToCapitalize.replace(slicedWord, slicedWord.toUpperCase()); eliminating the second line
}