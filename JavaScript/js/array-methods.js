...
// slice - returns a shallow copy(copying method) of a portion of an array into a new array object selected from start to end (end not included). The original array won't be modified.
//Syntax
// slice()
// slice(start)
// slice(start, end)
